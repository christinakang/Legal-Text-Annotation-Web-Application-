...
function getLegalConcepts() {
    ...
    // remember to update the same one in scenario.html script.
    const legalConcepts = [
        {'id': 1, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'absolute and unqualified, [4.054]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:absolute and unqualified, [4.054]:case example, [4.055]}<br>']}
,
...
,
{'id': 4, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'communication of, [4.069]–[4.086]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:completion, [4.077]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:conditions unfulfilled despite, [4.075]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:deeming, [4.071]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:effective, determination, [4.077]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:English law, [4.069], [4.070], [4.073]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:general rule, [4.069]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:Malaysia, [4.070]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:means, [4.072]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:omission, acceptance by, [4.072], [4.074]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:silence, by, [4.073], [4.076]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:timing, [4.078]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:unilateral proposals, [4.075]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:\\tcase, [4.079]}<br>', '<br>{Acceptance, [4.052]–[4.063]:communication of, [4.069]–[4.086]:\\tcase analysis, [4.080], [4.081]}<br>']}
,
...
,
{'id': 11, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'oral contract case example, [4.057]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:oral contract case example, [4.057]:evidence, importance, [4.058]}<br>']}
,
{'id': 12, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'postal acceptance, problems, [4.062], [4.063], [4.082]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:case example, [4.078]}<br>', '<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:Contracts Act 1950 s 4(2), [4.080]–[4.082]}<br>', '<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:facts and evidence, [4.083]}<br>', '<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:limitation of rule, [4.086]}<br>', '<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:origins of rule, [4.084], [4.085]}<br>', '<br>{Acceptance, [4.052]–[4.063]:postal acceptance, problems, [4.062], [4.063], [4.082]:\\tcase analysis, [4.080], [4.081]}<br>']}
,
{'id': 13, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'prescribed means, [4.061]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:prescribed means, [4.061]:postal acceptance, problems, [4.062], [4.063]}<br>', '<br>{Acceptance, [4.052]–[4.063]:prescribed means, [4.061]:redundancy, [4.060]}<br>']}
,
{'id': 14, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'proposal conditions, [4.054]', 'tertiaryies': [''], 'combine_concept': []}
,
{'id': 15, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'proposal revoked before, [4.087]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:proposal revoked before, [4.087]:case example, [4.088]}<br>']}
,
{'id': 16, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'reform', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:reform:necessity, [4.124]}<br>', '<br>{Acceptance, [4.052]–[4.063]:reform:reason, [4.125]}<br>']}
,
{'id': 17, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'requirement to make business and economic sense, [4.043]–[4.045]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:requirement to make business and economic sense, [4.043]–[4.045]:case example, [4.043]}<br>', '<br>{Acceptance, [4.052]–[4.063]:requirement to make business and economic sense, [4.043]–[4.045]:effect of not making sense, [4.045]}<br>', '<br>{Acceptance, [4.052]–[4.063]:requirement to make business and economic sense, [4.043]–[4.045]:principle, [4.044]}<br>']}
,
{'id': 18, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'revocation, [4.117]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:acceptor’s advantages, [4.119]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:communication, [4.118]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:Contracts Act 1950 s 3, [4.121]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:environment for judicial creativity, [4.122]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:general rule, [4.099]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:postal acceptance, [4.120]}<br>', '<br>{Acceptance, [4.052]–[4.063]:revocation, [4.117]:timing, [4.117], [4.118], [4.120]}<br>']}
,
{'id': 19, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'rules, [4.059]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:rules, [4.059]:redundancy of prescribed acceptance method, [4.060]}<br>']}
,
{'id': 20, 'primary': 'Acceptance, [4.052]–[4.063]', 'secondaryies': 'subject to contract, [4.065]', 'tertiaryies': [''], 'combine_concept': ['<br>{Acceptance, [4.052]–[4.063]:subject to contract, [4.065]:case examples, [4.066], [4.068]}<br>', '<br>{Acceptance, [4.052]–[4.063]:subject to contract, [4.065]:types of contract inapplicable, [4.067]}<br>', '<br>{Acceptance, [4.052]–[4.063]:subject to contract, [4.065]:use, [4.064]}<br>']}
,
...
,
{'id': 32, 'primary': 'Capacity, [7.035], [7.036], [7.055]', 'secondaryies': 'unsound mind, persons of, [7.045]', 'tertiaryies': [''], 'combine_concept': ['<br>{Capacity, [7.035], [7.036], [7.055]:unsound mind, persons of, [7.045]:caution, critical thought and evaluation, [7.048]}<br>', '<br>{Capacity, [7.035], [7.036], [7.055]:unsound mind, persons of, [7.045]:sound mind, [7.045]–[7.047]}<br>', '<br>{Capacity, [7.035], [7.036], [7.055]:unsound mind, persons of, [7.045]:unsound mind contracting during lucidity, [7.049], [7.050]}<br>']}
,
...
,
{'id': 35, 'primary': 'Consideration. See also Promissory estoppel', 'secondaryies': 'agreement made without is void, [5.010]–[5.013]', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration. See also Promissory estoppel:agreement made without is void, [5.010]–[5.013]:case examples, [5.012], [5.013]}<br>']}
,
...
,
{'id': 39, 'primary': 'Consideration sufficiency, [5.051]–[5.052]', 'secondaryies': 'inadequate consideration', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration sufficiency, [5.051]–[5.052]:inadequate consideration:immaterial, [5.045], [5.049]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:inadequate consideration:\\tcase examples, [5.044], [5.047]}<br>']}
,
{'id': 40, 'primary': 'Consideration sufficiency, [5.051]–[5.052]', 'secondaryies': 'natural love and affection', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration sufficiency, [5.051]–[5.052]:natural love and affection:case example, [5.057]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:natural love and affection:conditions for validity, [5.054]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:natural love and affection:Contracts Act 1950, [5.053], [5.055]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:natural love and affection:good consideration in Malaysia, [5.053]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:natural love and affection:near relations only, [5.056]}<br>']}
,
{'id': 41, 'primary': 'Consideration sufficiency, [5.051]–[5.052]', 'secondaryies': 'part payment of debt', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:common law invalidity, [5.069]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:Malaysia, in}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:\\tcase example, [5.072]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:\\tContracts Act 1950, [5.070]–[5.072]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:\\tpromisee forgoing debt without return, [5.071]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:part payment of debt:\\tstatutory waiver, [5.070]}<br>']}
,
{'id': 42, 'primary': 'Consideration sufficiency, [5.051]–[5.052]', 'secondaryies': 'performance of existing duty, [5.062]', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:contractual duty to promisor, [5.065]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:existing contractual duty to third party, [5.068]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:“practical benefit”, [5.067]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:public duties, [5.063]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:\\tcase examples, [5.065], [5.066]}<br>', '<br>{Consideration sufficiency, [5.051]–[5.052]:performance of existing duty, [5.062]:\\tcase examples, [5.063], [5.064]}<br>']}
,
...
,
{'id': 45, 'primary': 'Consideration sufficiency, [5.051]–[5.052]', 'secondaryies': 'value of consideration, [5.046]', 'tertiaryies': [''], 'combine_concept': ['<br>{Consideration sufficiency, [5.051]–[5.052]:value of consideration, [5.046]:inadequacy immaterial, [5.044], [5.045], [5.047], [5.049]}<br>']}
,
...
,
{'id': 73, 'primary': 'Duty of care. See also Negligence', 'secondaryies': 'omission, [15.048]–[15.051]', 'tertiaryies': [''], 'combine_concept': ['<br>{Duty of care. See also Negligence:omission, [15.048]–[15.051]:control of land or dangerous things, [15.056], [15.057]}<br>', '<br>{Duty of care. See also Negligence:omission, [15.048]–[15.051]:definition, [15.048]}<br>', '<br>{Duty of care. See also Negligence:omission, [15.048]–[15.051]:example, [15.050]}<br>']}
,
...
,
{'id': 81, 'primary': 'Employment terms and conditions, [16.002], [16.005]', 'secondaryies': 'validity, [16.039]', 'tertiaryies': [''], 'combine_concept': ['<br>{Employment terms and conditions, [16.002], [16.005]:validity, [16.039]:express prohibition, [16.0365}<br>', '<br>{Employment terms and conditions, [16.002], [16.005]:validity, [16.039]:\\texample, [16.040]}<br>']}
,
...
,
{'id': 88, 'primary': 'Insurance and doctrine of proximate cause', 'secondaryies': 'takaful, [24.050]–[24.052]', 'tertiaryies': [''], 'combine_concept': ['<br>{Insurance and doctrine of proximate cause:takaful, [24.050]–[24.052]:operator not liable for uncovered/excluded peril, [24.053]–[24.054]}<br>']}
,
...
,
{'id': 91, 'primary': 'Intention to create legal relationship', 'secondaryies': 'commercial agreements, [7.022]–[7.034]', 'tertiaryies': [''], 'combine_concept': ['<br>{Intention to create legal relationship:commercial agreements, [7.022]–[7.034]:case example (UK), [7.026], [7.027]}<br>', '<br>{Intention to create legal relationship:commercial agreements, [7.022]–[7.034]:industry, relevance, [7.031]}<br>']}
,
{'id': 92, 'primary': 'Invitation to treat, [4.023]–[4.027]', 'secondaryies': 'common categories, [4.028]', 'tertiaryies': [''], 'combine_concept': ['<br>{Invitation to treat, [4.023]–[4.027]:common categories, [4.028]:advertisements, [4.029]–[4.032]}<br>', '<br>{Invitation to treat, [4.023]–[4.027]:common categories, [4.028]:auctions, [4.033]–[4.036]}<br>', '<br>{Invitation to treat, [4.023]–[4.027]:common categories, [4.028]:options, [4.039]–[4.042]}<br>', '<br>{Invitation to treat, [4.023]–[4.027]:common categories, [4.028]:tenders, [4.037], [4.038]}<br>']}
,
{'id': 93, 'primary': 'Invitation to treat, [4.023]–[4.027]', 'secondaryies': 'definition, [4.024]', 'tertiaryies': [''], 'combine_concept': ['<br>{Invitation to treat, [4.023]–[4.027]:definition, [4.024]:Contracts Act 1950 not providing, [4.023]}<br>']}
,
{'id': 94, 'primary': 'Invitation to treat, [4.023]–[4.027]', 'secondaryies': 'presumption and challenge, [4.026]', 'tertiaryies': [''], 'combine_concept': ['<br>{Invitation to treat, [4.023]–[4.027]:presumption and challenge, [4.026]:case example, [4.027]}<br>']}
,
...
,
{'id': 98, 'primary': 'Law of agency', 'secondaryies': 'agency relationship, [14.005], [14.006]', 'tertiaryies': [''], 'combine_concept': ['<br>{Law of agency:agency relationship, [14.005], [14.006]:contracts, [14.007]}<br>', '<br>{Law of agency:agency relationship, [14.005], [14.006]:Latin maxim, [14.008]}<br>']}
,
{'id': 99, 'primary': 'Law of agency', 'secondaryies': 'agent, definition, [14.005]', 'tertiaryies': [''], 'combine_concept': []}
,
{'id': 100, 'primary': 'Law of agency', 'secondaryies': 'English law in Malaysia, influence, [14.002]–[14.004]', 'tertiaryies': [''], 'combine_concept': ['<br>{Law of agency:English law in Malaysia, influence, [14.002]–[14.004]:Civil Law Act 1956 (Mal) ss 3 and 5, [14.002], [14.004]}<br>', '<br>{Law of agency:English law in Malaysia, influence, [14.002]–[14.004]:cut-off dates, [14.003]}<br>']}
,
...
,
{'id': 106, 'primary': 'Mental disorder', 'secondaryies': 'capacity to contract of persons of unsound mind, [7.045]', 'tertiaryies': [''], 'combine_concept': ['<br>{Mental disorder:capacity to contract of persons of unsound mind, [7.045]:caution, critical thought and evaluation, [7.048]}<br>', '<br>{Mental disorder:capacity to contract of persons of unsound mind, [7.045]:sound mind, [7.045]–[7.047]}<br>', '<br>{Mental disorder:capacity to contract of persons of unsound mind, [7.045]:unsound mind contracting during lucidity, [7.049], [7.050]}<br>']}
,
...
,
{'id': 116, 'primary': 'Oral contracts', 'secondaryies': 'acceptance case example, [4.057]', 'tertiaryies': [''], 'combine_concept': ['<br>{Oral contracts:acceptance case example, [4.057]:evidence, importance, [4.058]}<br>']}
,
...
,
{'id': 120, 'primary': 'Proposal', 'secondaryies': 'communication of, [4.046]–[4.051]', 'tertiaryies': [''], 'combine_concept': ['<br>{Proposal:communication of, [4.046]–[4.051]:acceptance motive, [4.051]}<br>', '<br>{Proposal:communication of, [4.046]–[4.051]:case example, [4.049]}<br>', '<br>{Proposal:communication of, [4.046]–[4.051]:effect, [4.048]}<br>', '<br>{Proposal:communication of, [4.046]–[4.051]:knowledge of proposee required, [4.047], [4.050]}<br>', '<br>{Proposal:communication of, [4.046]–[4.051]:means of communication, [4.046]}<br>']}
,
{'id': 121, 'primary': 'Proposal', 'secondaryies': 'examples of analysis of existence, [4.006], [4.007]', 'tertiaryies': [''], 'combine_concept': []}
,
{'id': 122, 'primary': 'Proposal', 'secondaryies': 'requirement to make business and economic sense, [4.043]–[4.045]', 'tertiaryies': [''], 'combine_concept': ['<br>{Proposal:requirement to make business and economic sense, [4.043]–[4.045]:case example, [4.043]}<br>', '<br>{Proposal:requirement to make business and economic sense, [4.043]–[4.045]:effect of not making sense, [4.045]}<br>', '<br>{Proposal:requirement to make business and economic sense, [4.043]–[4.045]:principle, [4.044]}<br>']}
,
{'id': 123, 'primary': 'Proposal', 'secondaryies': 'test for, objective, [4.008]', 'tertiaryies': [''], 'combine_concept': ['<br>{Proposal:test for, objective, [4.008]:case examples, [4.009], [4.010]}<br>']}
,
{'id': 124, 'primary': 'Proposal revocation, [4.087]', 'secondaryies': 'common law, [4.093], [4.097]', 'tertiaryies': [''], 'combine_concept': ['<br>{Proposal revocation, [4.087]:common law, [4.093], [4.097]:English cases, [4.094], [4.095]}<br>']}
,
{'id': 125, 'primary': 'Proposal revocation, [4.087]', 'secondaryies': 'communication, [4.091], [4.099], [4.100]', 'tertiaryies': [''], 'combine_concept': ['<br>{Proposal revocation, [4.087]:communication, [4.091], [4.099], [4.100]:third party, by, [4.096]}<br>']}
,
{'id': 126, 'primary': 'Pure economic loss', 'secondaryies': 'duty of care, [15.036]–[15.047]', 'tertiaryies': [''], 'combine_concept': ['<br>{Pure economic loss:duty of care, [15.036]–[15.047]:connection with damage type, [15.046]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:contractual matrix, [15.047]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:defective structures and products, [15.043]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:English courts’ caution, [15.042]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:negligent misstatements, [15.041]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:proximity, [15.045]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:special relationship between parties, [15.040]}<br>', '<br>{Pure economic loss:duty of care, [15.036]–[15.047]:criteria, [15.039]}<br>']}
,
...
,
{'id': 141, 'primary': 'Unsound mind', 'secondaryies': 'capacity to contract of persons of unsound mind, [7.045]', 'tertiaryies': [''], 'combine_concept': ['<br>{Unsound mind:capacity to contract of persons of unsound mind, [7.045]:caution, critical thought and evaluation, [7.048]}<br>', '<br>{Unsound mind:capacity to contract of persons of unsound mind, [7.045]:sound mind, [7.045]–[7.047]}<br>', '<br>{Unsound mind:capacity to contract of persons of unsound mind, [7.045]:unsound mind contracting during lucidity, [7.049], [7.050]}<br>']}
,
